"""
Django settings for sved project.
...
SECRET_KEY = 'django-insecure-$08fb10x^1_d(ag&4d*fma4r85v7zik@-%7son8)^@w_wrx@^3'
...
WSGI_APPLICATION = 'sved.wsgi.application'
